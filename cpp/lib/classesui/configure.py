...
class ClassesuiModuleMakefile(pyqtconfig.QtCoreModuleMakefile):
...
#	qt_sip_flags = config.pyqt_qt_sip_flags
	...
	if opt_generate_code:
		...
		ret = os.system(" ".join([sip_bin, "-k", "-c", sipOutputDir, "-b", sipOutputDir+"/" + build_file, "-I", config.pyqt_sip_dir, "-I", config.default_sip_dir, "-I", config.sip_mod_dir, config.pyqt_sip_flags, "sip/classesui.sip"]))
		if ret:
			sys.exit(ret%255)
	...
	makefile = ClassesuiModuleMakefile(
...
#		install_dir=os.path.join(config.default_mod_dir,"blur"),
	...
	if sys.platform == "win32":
		makefile.extra_libs = ["stone","QtSql4","QtXml4","QtNetwork4","stonegui","classes","classesui","Mpr"]
	elif sys.platform == "darwin":
		makefile.extra_libs = ["stone","stonegui","classes","classesui"]
	else:
		makefile.extra_libs = ["stone","QtSql","QtXml","QtNetwork","stonegui","classes","classesui"]

	makefile.extra_include_dirs = ["../.out","../../stone/include","../include","../../classes/autocore"]
	makefile.extra_include_dirs += ["../../classes/base","../../classes","../../stonegui/include","../src"]
	makefile.extra_lib_dirs += [ "..", "../../stone", "../../stonegui", "../../classes" ]
	...
	content = {
		...
		# installed.
		"classesui_sip_dir":    config.default_sip_dir,

		# Publish the set of SIP flags needed by this module.  As these are the
		# same flags needed by the qt module we could leave it out, but this
		# allows us to change the flags at a later date without breaking
		# scripts that import the configuration module.
		"classesui_sip_flags":  qt_sip_flags
	}

	# This creates the helloconfig.py module from the helloconfig.py.in
	# template and the dictionary.
	#sipconfig.create_config_module("classesuiconfig.py", "classesuiconfig.py.in", content)
