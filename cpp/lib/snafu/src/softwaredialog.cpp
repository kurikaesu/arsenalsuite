...
/*
 * $Id: softwaredialog.cpp 5408 2007-12-18 00:13:49Z brobison $
 */

#include "softwaredialog.h"

SoftwareDialog::SoftwareDialog(QWidget * parent, Qt::WindowFlags f) : QDialog(parent, f)
{
	setupUi(this);
}
...
QString SoftwareDialog::name() const
{
	return mNameEdit->text();
}

QString SoftwareDialog::version() const
{
	return mVersionEdit->text();
}
