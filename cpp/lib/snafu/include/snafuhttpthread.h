...
/*
 * $Id: snafuhttpthread.h 5408 2007-12-18 00:13:49Z brobison $
 */

#ifndef SNAFUHTTPTHREAD_H
#define SNAFUHTTPTHREAD_H

#include <QThread>
#include <QHttp>

class SnafuHttpThread : public QThread
{
	Q_OBJECT

public:
	SnafuHttpThread(const QString & url, QObject *parent);
	void run();
