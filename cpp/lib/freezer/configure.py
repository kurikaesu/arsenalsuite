...
class FreezerModuleMakefile(pyqtconfig.QtCoreModuleMakefile):
	...
	def __init__(self, *args, **kw):
		...
		if not kw.has_key("qt"):
			kw["qt"] = ["QtCore", "QtXml", "QtSql","QtNetwork","QtGui","QtOpenGL","QtWebKit"]
...
#	qt_sip_flags = config.pyqt_qt_sip_flags
	...
	makefile = FreezerModuleMakefile(
	...
	if sys.platform == "win32":
		makefile.extra_libs = ["freezer","classes","stone","QtSql4","QtXml4","QtNetwork4","absubmit","Mpr"]
	elif sys.platform == "darwin":
		makefile.extra_libs = ["freezer","classes","stone","absubmit"]
	else:
		makefile.extra_libs = ["freezer","classes","stone","QtSql","QtXml","QtNetwork","absubmit"]

	makefile.extra_include_dirs = ["../.out","../../stone/include","../../stonegui/include","../include","../../classes/autocore","../../classes","../../classesui/include","../../classesui/.out/"]
