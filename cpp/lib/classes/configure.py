...
class ClassesModuleMakefile(pyqtconfig.QtCoreModuleMakefile):
...
#	qt_sip_flags = config.pyqt_qt_sip_flags
	...
	if opt_generate_code:
		...
		ret = os.system(" ".join([sip_bin, "-e", "-k", "-c", sipOutputDir, "-b", sipOutputDir+"/" + build_file, "-I", config.pyqt_sip_dir, "-I", config.default_sip_dir, "-I", config.sip_mod_dir, config.pyqt_sip_flags, "sip/classes.sip"]))
		if ret:
			sys.exit(ret%255)
	...
	makefile = ClassesModuleMakefile(
...
#   installs.append(["classesconfig.py", config.default_mod_dir])
	...
	if sys.platform == "win32":
		makefile.extra_libs = ["stone","QtSql4","QtXml4","QtNetwork4","classes","Mpr"]
	elif sys.platform == "darwin":
		makefile.extra_libs = ["stone","classes"]
	else:
		makefile.extra_libs = ["stone","QtSql","QtXml","QtNetwork","classes"]

	makefile.extra_include_dirs = ["../autocore","..","../../stone/include","/usr/include/stone"]
	...
	content = {
		...
		# installed.
		"classes_sip_dir":    config.default_sip_dir,

		# Publish the set of SIP flags needed by this module.  As these are the
		# same flags needed by the qt module we could leave it out, but this
		# allows us to change the flags at a later date without breaking
		# scripts that import the configuration module.
		"classes_sip_flags":  qt_sip_flags
	}

	# This creates the helloconfig.py module from the helloconfig.py.in
	# template and the dictionary.
	sipconfig.create_config_module("classesconfig.py", "classesconfig.py.in", content)
