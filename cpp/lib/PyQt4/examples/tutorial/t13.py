...
class CannonField(QtGui.QWidget):
    ...
    canShoot = QtCore.pyqtSignal(bool)
...
class GameBoard(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        angle.valueChanged.connect(self.cannonField.setAngle)
        self.cannonField.angleChanged.connect(angle.setValue)

        force.valueChanged.connect(self.cannonField.setForce)
        ...
        self.cannonField.canShoot.connect(shoot.setEnabled)
        ...
        self.hits.setSegmentStyle(QtGui.QLCDNumber.Filled)

        self.shotsLeft = QtGui.QLCDNumber(2)
        self.shotsLeft.setSegmentStyle(QtGui.QLCDNumber.Filled)
